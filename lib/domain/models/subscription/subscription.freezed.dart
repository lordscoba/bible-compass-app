  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.dateExpiring, dateExpiring) ||
                other.dateExpiring == dateExpiring) &&
...
class _$_SubscriptionState implements _SubscriptionState {
  ...
  @override
  String toString() {
    return 'SubscriptionState(data: $data, isLoading: $isLoading, error: $error, isLoggedIn: $isLoggedIn)';
  }
...
abstract class _SubscriptionState implements SubscriptionState {
  const factory _SubscriptionState(
      ...
      final bool isLoading,
      final String error,
      final bool isLoggedIn}) = _$_SubscriptionState;
